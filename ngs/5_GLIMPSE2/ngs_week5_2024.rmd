...
::: {#next-generation-sequence-analysis-homework-week-5-2024 .section .level3}
...
::: {#assignment-objective .section .level4}
...
::: {#completing-your-assignment .section .level4}
...
::: {#additional-readings .section .level4}
#### Additional readings
...
::: {#task-1-the-vcf-format-and-selecting-variants-that-passed-the-vqsr-based-sensitivity-filter .section .level4}
...
``` bash
gunzip -c joint_germline_recalibrated.vcf.gz | less # try searching for the last line of the header using '/CHROM' and then inspect the variant lines after using down arrow
```
...
::: {#task-2-glimpse2-imputation-of-missing-genotypes-in-low-coverage-datasets .section .level5}
